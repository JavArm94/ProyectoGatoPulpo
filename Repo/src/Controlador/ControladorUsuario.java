...
public class ControladorUsuario implements MouseListener,ActionListener {

	private VistaUsuario vc;
	...
	public ControladorUsuario() {
		this.setVc(new VistaUsuario(this));
		vc.setVisible(true);
	...
	public VistaUsuario getVc() {
		return vc;
	}

	public void setVc(VistaUsuario vc) {
		this.vc = vc;
	}
